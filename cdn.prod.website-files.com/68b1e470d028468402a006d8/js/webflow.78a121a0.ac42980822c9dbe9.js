  ...
  var e = {
        ...
        window.tram = (function (e) {
          ...
          var F = (t.frame =
            ...
            M = (t.now =
              (l =
                (s = p.performance) &&
                (s.now || s.webkitNow || s.msNow || s.mozNow)) && w.bind
                ? l.bind(s)
                : Date.now ||
                  function () {
                    return +new Date();
            ...
            P = c(function (t) {
              ...
              (t.init = function (t) {
                ...
                w.backface &&
                  W.hideBackface &&
                  X(this.el, w.backface.css, "hidden");
              }),
                T("add", n),
                T("start", i),
                T("wait", function (e) {
          ...
          (t.fallback = function (e) {
            if (!w.transition) return (W.fallback = !0);
            W.agentTests.push("(" + e + ")");
          ...
          var X = e.style,
            z = e.css,
            Q = { transform: w.transform && w.transform.css },
            Y = {
              color: [k, y],
          ...
          (i.debounce = function (e, t, n) {
            var r,
              ...
              l = function () {
                ...
                c < t
                  ? (r = setTimeout(l, t - c))
                  : ((r = null), n || ((s = e.apply(o, a)), (o = a = null)));
              };
            return function () {
      ...
      3949: function (e, t, n) {
        ...
        var m = navigator.userAgent.toLowerCase(),
          ...
          _ = (a.env.ios = /(ipod|iphone|ipad)/.test(m));
        (a.env.safari = /safari/.test(m) && !v && !_),
          h &&
          ...
          (e.exports = function (e, t) {
            ...
            function L(n, i) {
              ...
              I ||
                ...
                (I.outside =
                  ((r = I).outside && f.off("click" + g, r.outside),
                  function (t) {
                    var n = e(t.target);
              ...
              T &&
                ...
                u
                  ...
                  : ((l = I).overlay ||
                      ...
                      U(l, !0)),
                    I.button.on("click" + g, C(I)),
                    I.menu.on("click" + g, "a", F(I)),
                    I.button.on(
                      "keydown" + g,
                      ((c = I),
                      function (e) {
                        switch (e.keyCode) {
                          ...
                          case a.ESCAPE:
                            return (
                              U(c), e.preventDefault(), e.stopPropagation()
                            );
                          case a.ARROW_RIGHT:
                          case a.ARROW_DOWN:
                          case a.HOME:
              ...
              l.preview =
                function () {
                  (u = E && i.env("design")),
                    (s = i.env("editor")),
                    (n = e(document.body)),
                    (o = f.find(g)).length && (o.each(L), O(), i.resize.on(b));
                }),
              (l.destroy = function () {
                (_ = e()), O(), o && o.length && o.each(R);
              });
      ...
      3946: function (e, t, n) {
        ...
        let a = n(7087),
          ...
          k = (e = 1) => ({ type: I, payload: { step: e } }),
          x = (e, t) => ({ type: T, payload: { stateKey: e, newState: t } }),
          V = (e, t) => ({ type: y, payload: { now: e, parameters: t } }),
          U = (e, t) => ({ type: m, payload: { key: e, value: t } }),
          B = (e) => ({ type: h, payload: { ...e } }),
          j = (e, t) => ({ type: v, payload: { instanceId: e, time: t } }),
      ...
      1970: function (e, t, n) {
        ...
        function ee(e, t) {
          ...
          if (i && r && c && u) {
            ...
            e && (c = k({ actionList: e, actionItemId: r, rawData: c }));
          }
          if (
            (ei({ store: t, rawData: c, allowEvents: o, testManual: s }),
          ...
          if (l && l.useFirstGroupAsInitialState) {
            ...
            a.forEach((i) => {
              ...
              o.forEach((r) => {
                ...
                eg({
                  destination: w(
                    { element: r, actionItem: i, elementApi: I },
                    o
                  ),
                  immediate: !0,
                  store: e,
        ...
        function eE({
          ...
          a >= E.length && (0, o.default)(f, "config.loop") && (a = 0),
            0 === a && g && a++;
          let T =
              (0 === a || (1 === a && g)) && v(f.action?.actionTypeId)
                ? f.config.delay
                : void 0,
              ...
              E &&
                N({
                  ...
                  let E = p ? Y(d)?.(c, o) : null,
                    g = p ? H(d)(c, o) : null;
                  _ = !0;
                  let y = D({ element: c, actionItem: o }),
                    m = w({ element: c, actionItem: o, elementApi: I }, E);
                  eg({
                    store: e,
                    element: c,
                    actionItem: o,
        ...
        function eg(e) {
          ...
          S({ store: n, select: ({ ixInstances: e }) => e[f], onChange: ey }),
        ...
        function eI(e, t) {
          ...
          let { elementId: n, actionItem: i } = e,
            ...
            { ref: a, refType: o } = r[n] || {};
          o === b && B(a, i, I), t.dispatch((0, g.instanceRemoved)(e.id));
        }
        function eT(e, t, n) {
        ...
        function ey(e, t) {
          let {
            ...
            { events: O } = v,
            { mediaQueries: R = v.mediaQueryKeys } = O && O[d] ? O[d] : {};
          if (U(R, _.mediaQueryKey) && (i || n || r)) {
            if (l || (s === L && r)) {
              t.dispatch((0, g.elementStateChanged)(a, u, l, o));
              let { ixElements: e } = t.getState(),
                { ref: n, refType: i, refState: r } = e[a] || {},
                c = r && r[u];
              (i === b || Q(u)) && F(n, r, c, d, o, y, I, s, h);
            }
            if (r) {
              if (T) {
                let e = eE({
      ...
      8955: function (e, t, n) {
        ...
        let {
          ...
          ec = (e = !0) => ({
            ...
            handler: H(
              e ? X : j,
              ea((e, t) => (t.isActive ? $.handler(e, t) : t))
            ),
          }),
          ed = (e = !0) => ({
            ...q,
            handler: H(
              e ? X : j,
              ea((e, t) => (t.isActive ? t : $.handler(e, t)))
            ),
          }),
          ef = {
            ...J,
          ...
          ep = {
            ...
            [_]: ec(),
            [O]: ed(),
            [P]: { types: "ecommerce-cart-open", handler: H(X, Y) },
            [M]: { types: "ecommerce-cart-close", handler: H(X, Y) },
            [f]: {
              types: "click",
              handler: H(
                X,
              ...
              handler: (
                ...
                switch (o) {
                  ...
                  case u.EventBasedOn.PAGE: {
                    ...
                    m = T ? Math.min(e + g, n) / n : Math.min(t + I, i) / i;
                    break;
                  }
                ...
                return (
                  ...
                  (o !== u.EventBasedOn.ELEMENT ||
                    ...
                    v !== a.elementHovered) &&
                    ((m = d ? 1 - m : m),
                    e.dispatch((0, l.parameterChanged)(h, m))),
                  {
                    elementHovered: v,
                    clientX: p,
                    clientY: E,
              ...
              handler: (
                ...
                }
                {
                  ...
                  let s = a.top + Math.min(a.height * o, d),
                    f = Math.min(d + (a.top + a.height * u - s), c),
            ...
            [D]: {
              types: "readystatechange IX2_PAGE_UPDATE",
              handler: H(j, (e, t) => (t || Y(e), { started: !0 })),
            },
          };
      },
      4609: function (e, t, n) {
          ...
          m = (e, t) => {
            ...
            if (n && !i)
              ...
              for (let e = 0, { length: r } = c; e < r; e++) {
                let r = c[e],
                  a = I(g, r, n.config),
                  o = (I(g, r, i.config) - a) * t + a;
                R[r] = o;
              }
            }
            return (0, a.merge)(e, { position: b, current: R });
          },
          h = (e, t) => {
            let {
                active: n,
      ...
      4124: function (e, t, n) {
        ...
        let {
          ...
          eu = (e) => e.trim(),
          es = Object.freeze({ [en]: C, [ei]: F, [er]: M }),
          el = Object.freeze({
        ...
        function eh({
          ...
          if (b === l.EventAppliesTo.PAGE) {
            let e = c(h);
            return e ? [e] : [];
          }
          let R = (t?.action?.config?.affectedElements ?? {})[h || _] || {},
            N = !!(R.id || R.selector),
            A = t && d(em(t.target));
          if (
            (N
              ? ((a = R.limitAffectedElements), (o = A), (u = d(R)))
              : (o = u = d({ id: h, selector: _, selectorGuids: O })),
            t && L)
          ) {
            let e = n && (u || !0 === L) ? [n] : f(A);
            if (u) {
              if (L === k) return f(u).filter((t) => e.some((e) => T(t, e)));
              if (L === P) return f(u).filter((t) => e.some((e) => T(e, t)));
              if (L === G) return f(u).filter((t) => e.some((e) => y(e, t)));
            }
            return e;
          }
        ...
        function ew({ element: e, actionItem: t, elementApi: n }) {
          ...
          switch (t.actionTypeId) {
            ...
            case et: {
              ...
              if (o === U) {
                let t = i(e, w);
                r(e, w, ""), (s = a(e, "offsetWidth")), r(e, w, t);
              }
              if (u === U) {
                let t = i(e, S);
                r(e, S, ""), (l = a(e, "offsetHeight")), r(e, S, t);
              }
              ...
              let T = ek
                  .map((e) => {
                    ...
                    switch (e) {
                      ...
                      case $:
                        return `${m}(${n}${a}, ${i}${o}, ${r}${u})`;
                      case q:
                        return `${h}(${n}${a}) ${v}(${i}${o}) ${_}(${r}${u})`;
                      case K:
                        return `${O}(${n}${a}, ${i}${o})`;
                      default:
                        return "";
                  ...
                  .join(" "),
                { setStyle: R } = I;
              eU(c, E.TRANSFORM_PREFIXED, I),
                R(c, E.TRANSFORM_PREFIXED, T),
                (function (
                  { actionTypeId: e },
              ...
              return (function (e, t, n, i, r, a) {
                ...
                switch (i.actionTypeId) {
                  case et: {
                    ...
                    void 0 !== o &&
                      (t === U && (t = "px"), eU(e, w, a), u(e, w, o + t)),
                      void 0 !== s &&
                        (r === U && (r = "px"), eU(e, S, a), u(e, S, s + r));
                    break;
                  }
                  case J:
                    var s = i.config;
        ...
        function eX({ actionGroup: e, event: t, elementApi: n }) {
          ...
          i.forEach((e) => {
            ...
            (i = (0, p.isPluginType)(r)
              ...
              : eQ({ effect: eY, actionTypeId: r, elementApi: n })),
        ...
        function ez(e, t, n) {
          ...
          if (a === et) {
            let { config: n } = t;
            n.widthUnit === U && i(e, w, ""), n.heightUnit === U && i(e, S, "");
          }
          r(e, V) && eQ({ effect: eB, actionTypeId: a, elementApi: n })(e);
        }
        let eQ =
        ...
        function eq({ actionList: e, actionItemId: t, rawData: n }) {
          let { actionItemGroups: i, continuousParameterGroups: r } = e,
            a = [],
            o = (e) => (
              a.push((0, s.mergeIn)(e, ["config"], { delay: 0, duration: 0 })),
              e.id === t
            );
          return (
      ...
      5861: function (e, t, n) {
            ...
            switch (t.type) {
              ...
              case m: {
                let {
                  ...
                  l = e;
                return (
                  (0, a.getIn)(l, [n, i]) !== i && (l = O(l, i, u, n, o)),
                  b(l, n, s, r, o)
                );
              }
              case h: {
        ...
        function O(e, t, n, i, r) {
          let o =
            n === s ? (0, a.getIn)(r, ["config", "target", "objectId"]) : null;
        ...
        Webflow.require("ix2").init({
          events: {
            e: {
              ...
              target: {
                id: "68b1e471d028468402a00713|df036dc2-a75c-63e5-5577-dc3861539a00",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
              },
              targets: [
            ...
            "e-3": {
              ...
              mediaQueries: ["main", "medium", "small", "tiny"],
              target: {
                id: "68b1e471d028468402a00713|d03f2929-62e4-972c-18e2-b9e9ff1bc21e",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
              },
              targets: [
            ...
            "e-5": {
              ...
              action: {
                ...
                instant: !1,
                config: { actionListId: "jiggle", autoStopEventId: "e-6" },
              },
              mediaQueries: ["main", "medium", "small", "tiny"],
              target: {
                id: "68b1e471d028468402a00713|64ef6c8e-e631-7612-4439-b6ca0f0d9481",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
              },
              targets: [
            ...
            "e-7": {
              ...
              action: {
                ...
                instant: !1,
                config: { actionListId: "jello", autoStopEventId: "e-8" },
              },
              mediaQueries: ["main", "medium", "small", "tiny"],
              target: {
                id: "68b1e471d028468402a00713|a1509139-17f8-d8a4-0819-de15b0bb71a9",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
              },
              targets: [
            ...
            "e-9": {
              ...
              action: {
                ...
                instant: !1,
                config: { actionListId: "growBigIn", autoStopEventId: "e-10" },
              },
              mediaQueries: ["main", "medium", "small", "tiny"],
              target: {
                id: "68b1e471d028468402a00713|6c3137a8-4fec-9e2f-68df-cfa1dd37a629",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
              },
              targets: [
            ...
            "e-11": {
              ...
              mediaQueries: ["main", "medium", "small", "tiny"],
              target: {
                id: "68b1e471d028468402a00713|9b363b27-2984-cdbd-d563-d8e8c7918982",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
              },
              targets: [
            ...
            "e-13": {
              ...
              mediaQueries: ["main", "medium", "small", "tiny"],
              target: {
                id: "68b1e471d028468402a00713|2730337d-1aba-6445-f145-357aadadbbc4",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
              },
              targets: [
            ...
            "e-15": {
              ...
              mediaQueries: ["main", "medium", "small", "tiny"],
              target: {
                id: "68b1e471d028468402a00713|99bb7a39-83d0-dd4f-f235-ce36ad8e7255",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
              },
              targets: [
            ...
            "e-17": {
              ...
              mediaQueries: ["main", "medium", "small", "tiny"],
              target: {
                id: "68b1e471d028468402a00713|6cf77421-c09f-46af-bafb-7330f9eaff8c",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
              },
              targets: [
            ...
            "e-19": {
              ...
              mediaQueries: ["main", "medium", "small", "tiny"],
              target: {
                id: "68b1e471d028468402a00713|f9cf386e-bbbb-432a-dbcc-b1c9b94397b8",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
              },
              targets: [
            ...
            "e-21": {
              ...
              mediaQueries: ["main", "medium", "small", "tiny"],
              target: {
                id: "68b1e471d028468402a00713|f9cf386e-bbbb-432a-dbcc-b1c9b94397ba",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
              },
              targets: [
            ...
            "e-23": {
              ...
              mediaQueries: ["main", "medium", "small", "tiny"],
              target: {
                id: "68b1e471d028468402a00713|593b9b7c-8850-f08c-08f1-64816a982ff3",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
              },
              targets: [
            ...
            "e-25": {
              ...
              mediaQueries: ["main", "medium", "small", "tiny"],
              target: {
                id: "68b1e471d028468402a00713|593b9b7c-8850-f08c-08f1-64816a982ff5",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
              },
              targets: [
            ...
            "e-27": {
              ...
              action: {
                ...
                actionTypeId: "JELLO_EFFECT",
                instant: !1,
                config: { actionListId: "jello", autoStopEventId: "e-28" },
              },
              mediaQueries: ["main", "medium", "small", "tiny"],
              target: {
                id: "68b1e471d028468402a00713|99b7e88e-f06b-64ee-b0c6-7739d70ef2f1",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
              },
              targets: [
            ...
            "e-29": {
              ...
              action: {
                ...
                actionTypeId: "JELLO_EFFECT",
                instant: !1,
                config: { actionListId: "jello", autoStopEventId: "e-30" },
              },
              mediaQueries: ["main", "medium", "small", "tiny"],
              target: {
                id: "68b1e471d028468402a00713|0482f572-8a1d-3211-554c-64df5c08baee",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
              },
              targets: [
            ...
            "e-31": {
              ...
              action: {
                ...
                actionTypeId: "JELLO_EFFECT",
                instant: !1,
                config: { actionListId: "jello", autoStopEventId: "e-32" },
              },
              mediaQueries: ["main", "medium", "small", "tiny"],
              target: {
                id: "68b1e471d028468402a00713|9cfc5e2c-7024-b3ab-7501-fd667dd14600",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
              },
              targets: [
            ...
            "e-33": {
              ...
              action: {
                ...
                actionTypeId: "JELLO_EFFECT",
                instant: !1,
                config: { actionListId: "jello", autoStopEventId: "e-34" },
              },
              mediaQueries: ["main", "medium", "small", "tiny"],
              target: {
                id: "68b1e471d028468402a00713|ff57f2f6-664c-e36a-c3d3-c5766da87044",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
              },
              targets: [
            ...
            "e-35": {
              ...
              action: {
                ...
                instant: !1,
                config: { actionListId: "bounce", autoStopEventId: "e-36" },
              },
              mediaQueries: ["main", "medium", "small", "tiny"],
              target: {
                id: "68b1e471d028468402a00713|99b7e88e-f06b-64ee-b0c6-7739d70ef2f1",
            ...
            "e-37": {
              ...
              action: {
                ...
                actionTypeId: "BOUNCE_EFFECT",
                instant: !1,
                config: { actionListId: "bounce", autoStopEventId: "e-38" },
              },
              mediaQueries: ["main", "medium", "small", "tiny"],
              target: {
                id: "68b1e471d028468402a00713|0482f572-8a1d-3211-554c-64df5c08baee",
            ...
            "e-39": {
              ...
              action: {
                ...
                actionTypeId: "BOUNCE_EFFECT",
                instant: !1,
                config: { actionListId: "bounce", autoStopEventId: "e-40" },
              },
              mediaQueries: ["main", "medium", "small", "tiny"],
              target: {
                id: "68b1e471d028468402a00713|9cfc5e2c-7024-b3ab-7501-fd667dd14600",
            ...
            "e-41": {
              ...
              action: {
                ...
                actionTypeId: "BOUNCE_EFFECT",
                instant: !1,
                config: { actionListId: "bounce", autoStopEventId: "e-42" },
              },
              mediaQueries: ["main", "medium", "small", "tiny"],
              target: {
                id: "68b1e471d028468402a00713|ff57f2f6-664c-e36a-c3d3-c5766da87044",
            ...
            "e-45": {
              ...
              target: {
                appliesTo: "ELEMENT",
                styleBlockIds: [],
                id: "68b1e471d028468402a00713|2aad5dc1-a290-cbb2-7adb-3e5851227df0",
              },
              targets: [],
              config: {
                loop: !1,
            ...
            "e-47": {
              ...
              target: {
                appliesTo: "ELEMENT",
                styleBlockIds: [],
                id: "68b1e471d028468402a00713|335f6976-376f-35ce-500d-89ec83197da7",
              },
              targets: [],
              config: {
                loop: !1,
            ...
            "e-49": {
              ...
              action: {
                ...
                actionTypeId: "GROW_BIG_EFFECT",
                instant: !1,
                config: { actionListId: "growBigIn", autoStopEventId: "e-50" },
              },
              mediaQueries: ["main", "medium", "small", "tiny"],
              target: {
                id: "68b1e471d028468402a00713|4ad487b5-75a6-d3b1-00b7-14b0fd75b8cd",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
              },
              targets: [],
            ...
            "e-51": {
              ...
              target: {
                appliesTo: "ELEMENT",
                styleBlockIds: [],
                id: "68b1e471d028468402a00713|3f4d0497-da51-fa0f-666b-a02ff381457e",
              },
              targets: [],
              config: {
                loop: !1,
            ...
            "e-53": {
              ...
              action: {
                ...
                actionTypeId: "JELLO_EFFECT",
                instant: !1,
                config: { actionListId: "jello", autoStopEventId: "e-54" },
              },
              mediaQueries: ["main", "medium", "small", "tiny"],
              target: {
                id: "68b1e471d028468402a00713|cbc11065-4321-bb2c-6ce1-9738ded3c635",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
              },
              targets: [],
            ...
            "e-55": {
              ...
              action: {
                id: "",
                actionTypeId: "POP_EFFECT",
                config: { actionListId: "pop", autoStopEventId: "e-56" },
                instant: !1,
              },
              mediaQueries: ["main", "medium", "small", "tiny"],
              target: {
                appliesTo: "ELEMENT",
                styleBlockIds: [],
                id: "68b1e471d028468402a00713|cbc11065-4321-bb2c-6ce1-9738ded3c637",
              },
              targets: [],
              config: {
                loop: !1,
            ...
            "e-57": {
              ...
              target: {
                appliesTo: "ELEMENT",
                styleBlockIds: [],
                id: "68b1e471d028468402a00713|393311a9-f11b-aeb7-960a-3ec24e112477",
              },
              targets: [],
              config: {
                loop: !1,
            ...
            "e-59": {
              ...
              target: {
                appliesTo: "ELEMENT",
                styleBlockIds: [],
                id: "68b1e471d028468402a00713|752b0724-c202-d5ff-b4b3-351b07fb7074",
              },
              targets: [],
              config: {
                loop: !1,
            ...
            "e-61": {
              ...
              target: {
                appliesTo: "ELEMENT",
                styleBlockIds: [],
                id: "68b1e471d028468402a00713|9b7fadfb-9225-de24-fa9b-fb0605536fd8",
              },
              targets: [],
              config: {
                loop: !1,
            ...
            "e-63": {
              ...
              target: {
                appliesTo: "ELEMENT",
                styleBlockIds: [],
                id: "68b1e471d028468402a00713|9b7fadfb-9225-de24-fa9b-fb0605536fd9",
              },
              targets: [],
              config: {
                loop: !1,
            ...
            "e-83": {
              ...
              target: {
                appliesTo: "ELEMENT",
                styleBlockIds: [],
                id: "68b1e471d028468402a00713|6f79e45e-ba0e-c830-f268-36ccaf67e74f",
              },
              targets: [],
              config: {
                loop: !1,
            ...
            "e-85": {
              ...
              action: {
                id: "",
                actionTypeId: "SLIDE_EFFECT",
                config: { actionListId: "slideInTop", autoStopEventId: "e-86" },
                instant: !1,
              },
              mediaQueries: ["main", "medium", "small", "tiny"],
              target: {
                appliesTo: "ELEMENT",
                styleBlockIds: [],
                id: "68b1e471d028468402a00713|6f79e45e-ba0e-c830-f268-36ccaf67e750",
              },
              targets: [],
              config: {
                loop: !1,
            ...
            "e-87": {
              ...
              action: {
                ...
                actionTypeId: "JELLO_EFFECT",
                instant: !1,
                config: { actionListId: "jello", autoStopEventId: "e-88" },
              },
              mediaQueries: ["main", "medium", "small", "tiny"],
              target: {
                id: "68b1e471d028468402a00713|6f79e45e-ba0e-c830-f268-36ccaf67e752",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
              },
              targets: [],
            ...
            "e-91": {
              ...
              target: {
                appliesTo: "ELEMENT",
                styleBlockIds: [],
                id: "68b1e471d028468402a00713|6f79e45e-ba0e-c830-f268-36ccaf67e75d",
              },
              targets: [],
              config: {
                loop: !1,
            ...
            "e-93": {
              ...
              action: {
                id: "",
                actionTypeId: "SLIDE_EFFECT",
                config: { actionListId: "slideInTop", autoStopEventId: "e-94" },
                instant: !1,
              },
              mediaQueries: ["main", "medium", "small", "tiny"],
              target: {
                appliesTo: "ELEMENT",
                styleBlockIds: [],
                id: "68b1e471d028468402a00713|6f79e45e-ba0e-c830-f268-36ccaf67e75e",
              },
              targets: [],
              config: {
                loop: !1,
            ...
            "e-95": {
              ...
              action: {
                ...
                actionTypeId: "BOUNCE_EFFECT",
                instant: !1,
                config: { actionListId: "bounce", autoStopEventId: "e-96" },
              },
              mediaQueries: ["main", "medium", "small", "tiny"],
              target: {
                id: "68b1e471d028468402a00713|fe9b2e6f-50c3-c6f8-c3ad-c42d17556ddd",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
              },
              targets: [],
            ...
            "e-97": {
              ...
              action: {
                ...
                actionTypeId: "JELLO_EFFECT",
                instant: !1,
                config: { actionListId: "jello", autoStopEventId: "e-98" },
              },
              mediaQueries: ["main", "medium", "small", "tiny"],
              target: {
                id: "68b1e471d028468402a00713|fe9b2e6f-50c3-c6f8-c3ad-c42d17556ddd",
            ...
            "e-99": {
              ...
              action: {
                ...
                actionTypeId: "JELLO_EFFECT",
                instant: !1,
                config: { actionListId: "jello", autoStopEventId: "e-100" },
              },
              mediaQueries: ["main", "medium", "small", "tiny"],
              target: {
                id: "68b1e471d028468402a00713|f9296755-8932-bfb5-c106-76727d6ee56d",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
              },
              targets: [],
            ...
            "e-101": {
              ...
              action: {
                ...
                actionTypeId: "BOUNCE_EFFECT",
                instant: !1,
                config: { actionListId: "bounce", autoStopEventId: "e-102" },
              },
              mediaQueries: ["main", "medium", "small", "tiny"],
              target: {
                id: "68b1e471d028468402a00713|f9296755-8932-bfb5-c106-76727d6ee56d",
            ...
            "e-103": {
              ...
              action: {
                ...
                actionTypeId: "BOUNCE_EFFECT",
                instant: !1,
                config: { actionListId: "bounce", autoStopEventId: "e-104" },
              },
              mediaQueries: ["main", "medium", "small", "tiny"],
              target: {
                id: "68b1e471d028468402a00713|818486c8-88c3-c800-35be-3eca362ba3ed",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
              },
              targets: [],
            ...
            "e-105": {
              ...
              action: {
                ...
                actionTypeId: "JELLO_EFFECT",
                instant: !1,
                config: { actionListId: "jello", autoStopEventId: "e-106" },
              },
              mediaQueries: ["main", "medium", "small", "tiny"],
              target: {
                id: "68b1e471d028468402a00713|818486c8-88c3-c800-35be-3eca362ba3ed",
            ...
            "e-107": {
              ...
              action: {
                ...
                actionTypeId: "BOUNCE_EFFECT",
                instant: !1,
                config: { actionListId: "bounce", autoStopEventId: "e-108" },
              },
              mediaQueries: ["main", "medium", "small", "tiny"],
              target: {
                id: "68b1e471d028468402a00713|b055bf51-5de5-90fc-8cfb-7e547df9407f",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
              },
              targets: [],
            ...
            "e-109": {
              ...
              action: {
                ...
                actionTypeId: "JELLO_EFFECT",
                instant: !1,
                config: { actionListId: "jello", autoStopEventId: "e-110" },
              },
              mediaQueries: ["main", "medium", "small", "tiny"],
              target: {
                id: "68b1e471d028468402a00713|b055bf51-5de5-90fc-8cfb-7e547df9407f",
            ...
            "e-113": {
              ...
              action: {
                ...
                actionTypeId: "JELLO_EFFECT",
                instant: !1,
                config: { actionListId: "jello", autoStopEventId: "e-114" },
              },
              mediaQueries: ["main", "medium", "small", "tiny"],
              target: {
                id: "68b1e471d028468402a00713|f7aaafff-4542-8e7e-6427-81faa364a4f2",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
              },
              targets: [],
                  ...
                  actionItems: [
                    {
                      ...
                      config: {
                        ...
                        target: {
                          ...
                          selector: ".copied-button.active",
                          selectorGuids: [
                            "47f8fa07-035d-fd3c-7575-c1621994c7f0",
                            "47f8fa07-035d-fd3c-7575-c1621994c7f6",
                          ],
                        },
                        value: 0,
                        unit: "",
    ...
    (() => {
      ...
      n.O = (t, i, r, a) => {
        ...
        for (var u = 1 / 0, o = 0; o < e.length; o++) {
          for (var [i, r, a] = e[o], s = !0, l = 0; l < i.length; l++)
